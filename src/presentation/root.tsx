  ...
  return (
    <html lang="en">
      <head>
        ...
        <title>Sloper Generator</title>
        <meta property="og:title" content="Sloper Generator" />
        <meta
          name="description"
          content="Enter your measurements to generate custom basic blocks for all your pattern-making needs."
        />
