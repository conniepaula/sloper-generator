...
describe("waistLineLength", () => {
  it("calculates correct length given waist measurement and dart depth", () => {
    const waist = 60;
...
describe("originToShoulderDistance", () => {
  it("calculates distance from origin to shoulder using span, length and slope", () => {
...
describe("calculateBustDartIntake", () => {
  it("caps intake at 5 and otherwise returns raw difference", () => {
...
describe("createBaseCenterPoints", () => {
  it("returns center points with top at origin and bottom offset by height", () => {
    const height = 40;
...
describe("getDartVectorsAndRelations", () => {
  it("computes normalized dart vectors and their angle", () => {
...
describe("foldBustDart", () => {
  it("returns folded side seam line using rotation", () => {
...
describe("unfoldBustDart", () => {
  it("unfolds folded side seam into dart legs and side seams", () => {
    const bustOrigin = { x: 0, y: 0 };
    const armscyeEnd = { x: 2, y: 0 };
...
describe("traceBackSideSeam", () => {
  it("projects bust measurement when waist > bust", () => {
  ...
  it("intersects armscye when waist < bust", () => {
